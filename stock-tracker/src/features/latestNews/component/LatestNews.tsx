...
import { LatestNewsType } from "../redux/actions";
...
export const LatestNews = () => {
  ...
  const newsDisplay = (latestNews || []).map(
    (news: LatestNewsType, index: number) => (
      <div className="news" key={index}>
        <p
          className={index === 0 ? "first_news news_headline" : "news_headline"}
        >
